        ...
        <div className="px-4 md:px-8 lg:px-12 py-32 max-w-[1200px] w-full mx-auto">
          <div className="grid lg:grid-cols-2 items-end gap-12 mx-auto">
            <div className="about-content">
              ...
              <h2
                className="text-3xl md:text-4xl lg:text-6xl font-normal font-oswald text-WhitE mt-3 mb-7 max-w-[18ch] reveal-left"
                data-reveal
              >
              ...
              >
                ...
                <p className="text-base md:text-3xl italic text-WhitE">
